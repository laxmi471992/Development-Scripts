...
/* CHANGELOG:
  ...
  * -----------------------------------------------------------------------------------------------------------
  */
function complaintLogReminder($path, $id, $reportName, $code_name, $userType, $userReportName, $outputName, $reportDescription, $mailNotification, $sftpId, $mode, $run_by, $reportBasePath)
{
...
function Sendmail14($newid)
{
    global $mail;
    $mail->clearAddresses();
    $mail->addAddress($newid);
    $mail->Subject = 'Complaint Log Reminder';
    //LK18082026: updated body msg - AACA renamed to GPS 
